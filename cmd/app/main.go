...
func main() {
	...
	if err := persistence.AutoMigrate(db, &models.User{}, &models.Collection{}, &models.SavedRequest{}, &models.RequestHistory{}); err != nil {
	...
	r := server.NewRouter(cfg, userSvc, collectionSvc, requestSvc, historySvc)
